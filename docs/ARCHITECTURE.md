...
El diagrama editable está en [`ARCHITECTURE.mmd`](ARCHITECTURE.mmd). La exportación visual actual
del pipeline está en [`flow diagram pipeline.png`](flow%20diagram%20pipeline.png); usar el archivo
editable como fuente si se necesita una versión PNG o PDF actualizada.
