...
function errorMessage(error: unknown) {
  return error instanceof Error ? error.message : "The Control Tower API rejected the request.";
}
...
export function ChaosConsole() {
  ...
  const phaseMeta: Record<ChaosPhase, { label: string; detail: string; tone: string }> = {
    ...
    submitting: { label: "Submitting", detail: "Waiting for the Control Tower API to accept the scenario.", tone: "active" },
